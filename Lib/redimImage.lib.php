...
// - $rep_Dst : repertoire de l image de Destination (deprotŽgŽ) --> ou '' (meme repertoire)
// - $img_Dst : NOM de l image de Destination --> ou '' (meme nom que l image Source)
// - $rep_Src : repertoire de l image Source (deprotŽgŽ)
...
// ---------------------------------------------------------------------------------------
// $rep_Dst : il faut s'assurer que les droits en Žcriture ont ŽtŽ donnŽs au dossier (chmod)
...
function fctredimimage($W_max, $H_max, $rep_Dst, $img_Dst, $rep_Src, $img_Src) {
 ...
 // ----------------------------------------------------
 // si le fichier existe dans le rŽpertoire, on continue...
